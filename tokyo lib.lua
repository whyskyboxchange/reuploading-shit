...
local library = {
	...
	signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/whyskyboxchange/reuploading-shit/main/signal.lua'))();
	open = false;
	opening = false;
	hasInit = false;
	cheatname = startupArgs.cheatname or 'terracc';
